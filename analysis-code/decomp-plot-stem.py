...
filename='7vu6-decomp.dat'
#Obtaining the complete information of all residues
output_all_file='7vu6_all.dat'
#Obtaining energy contribution of key residues
output_key_file='7vu6_key.dat'

offset = 0
threshold=-1.0

png_save_path='7vu6-decomp.png'
max_residue=305 #The number of the last residue from the proteins
