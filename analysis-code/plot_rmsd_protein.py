...
file_paths = ['D:/cjzdat/3CLP/3pcl-python/rmsd/apo-rmsd.dat','D:/cjzdat/3CLP/3pcl-python/rmsd/7vu6-rmsd.dat', 
               'D:/cjzdat/3CLP/3pcl-python/rmsd/7vth-rmsd.dat', 'D:/cjzdat/3CLP/3pcl-python/rmsd/7lmf-rmsd.dat']
labels = ['APO 3CLP','7YY 3CLP', '7XB 3CLP', 'Y6G 3CLP']
...
ax.set_ylabel('RMSDs of proteins(Å)',fontweight='bold', fontsize=18)

save_path='D:/cjzdat/3CLP/pyfigure/rmsd-protein.png'
show_grid=True
